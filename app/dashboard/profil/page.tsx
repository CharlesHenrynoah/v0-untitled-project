...
export default function ProfilPage() {
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      companyName: "QuantumBridge Technologies",
      companyAddress: "102 Avenue des Algorithmes, 69007 Lyon, France",
      siret: "84910236500019",
      tva: "FR12345678900",
      firstName: "Thomas",
      lastName: "Dubois",
      email: "t.dubois@quantumbridge.fr",
      phone: "06 12 34 56 78",
      role: "CTO (Chief Technology Officer)",
      description:
        "QuantumBridge Technologies est une entreprise spécialisée dans le développement de solutions innovantes pour l'industrie du transport et de la logistique.",
    },
  })
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="flex flex-col justify-between space-y-2 md:flex-row md:items-center md:space-y-0">
            <h2 className="text-3xl font-bold tracking-tight text-navy-900">Mon Profil Entreprise</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Contact référent</CardTitle>
                <CardDescription>Informations du contact principal</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <FormField
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-2">
                      ...
                      <FormDescription>
                        Cette description sera visible par les chauffeurs et gestionnaires de flottes.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
