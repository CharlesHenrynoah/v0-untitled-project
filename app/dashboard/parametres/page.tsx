...
export default function ParametresPage() {
  ...
  // État displaySettings supprimé car non utilisé
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="email" defaultValue="t.dubois@quantumbridge.fr" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Soyez notifié des modifications de vos missions</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Recevez des rappels pour vos missions à venir</p>
                  </div>
                  <Switch
