  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between space-y-2 md:flex-row md:items-center md:space-y-0">
        <h2 className="text-3xl font-bold tracking-tight text-navy-900">Gestion des Flottes</h2>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Flottes personnalisées</CardTitle>
          <CardDescription>Créez et gérez vos groupes de chauffeurs</CardDescription>
        </CardHeader>
        <CardContent>
          <FlottesList />
        </CardContent>
